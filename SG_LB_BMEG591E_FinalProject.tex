...
\CommentTok{\#head(dge$samples) \# Data frame containing the normalization factors}
...
\includegraphics{SG_LB_BMEG591E_FinalProject_files/figure-latex/unnamed-chunk-2-1.pdf}
...
\NormalTok{onset\_labels }\OtherTok{=} \FunctionTok{HeatmapAnnotation}\NormalTok{(}\AttributeTok{bar =} \FunctionTok{c}\NormalTok{(}\FunctionTok{rep}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{49}\NormalTok{), }\FunctionTok{rep}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{50}\NormalTok{)),}
                                 \AttributeTok{col =} \FunctionTok{list}\NormalTok{(}\AttributeTok{bar =} \FunctionTok{c}\NormalTok{(}\StringTok{"1"} \OtherTok{=} \StringTok{"yellow"}\NormalTok{, }\StringTok{"0"} \OtherTok{=} \StringTok{"blue"}\NormalTok{)),}
...
\includegraphics{SG_LB_BMEG591E_FinalProject_files/figure-latex/unnamed-chunk-6-1.pdf}
...
heatmap in the paper seem to have higher expression levels visible in
the top left and bottom right quadrants, and lower expression in the
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Heat map 2, based on authors\textquotesingle{} DEG list:}
...
\includegraphics{SG_LB_BMEG591E_FinalProject_files/figure-latex/unnamed-chunk-7-1.pdf}
...
\includegraphics{SG_LB_BMEG591E_FinalProject_files/figure-latex/unnamed-chunk-9-1.pdf}
...
\includegraphics{SG_LB_BMEG591E_FinalProject_files/figure-latex/unnamed-chunk-10-1.pdf}
